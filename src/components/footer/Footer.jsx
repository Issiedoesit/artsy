...
export default function Footer(){
    return(
        <footer className='pb-10 space-y-20 px-20'>
            <section className='flex flex-row items-start'>
                <div className='w-twentyFivePercent'>
                    <img src={logo} alt='logo' className='w-40'/>
                </div>
                <div className='font-satoshi-regular text-2xl flex flex-row items-start w-fiftyPercent justify-evenly'>
                        <ul>
                            <li><NavLink className='hover:underline'  exact to='/'>Home</NavLink></li>
                            <li><NavLink className='hover:underline' exact to='/marketplace'>Marketplace</NavLink></li>
                            <li><NavLink className='hover:underline' exact to='/auctions'>Auctions</NavLink></li>
                            <li><NavLink className='hover:underline' exact to='/drops'>Drops</NavLink></li>
                        </ul>
                        <ul>
                            <li><NavLink className='hover:underline' exact to='/blog'>Blog</NavLink></li>
                            <li><NavLink className='hover:underline' exact to='/wallets'>Wallets</NavLink></li>
                            <li><NavLink className='hover:underline' exact to='/rates'>Rates</NavLink></li>
                            <li><NavLink className='hover:underline' exact to='/high-bids'>High bids</NavLink></li>
                        </ul>
                </div>
                <div className='w-twentyFivePercent'>
                    <div className='flex flex-row items-center'>
                        ...
                        <a href="mailto:">artsystudios@gmail.com</a>
                    </div>
                    <div className='flex flex-row items-center'>
            ...
            <p className='text-center'>Artsystudios © 2022. All Rights Reserved.</p>
        </footer>
    )
}